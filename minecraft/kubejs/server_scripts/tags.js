ServerEvents.tags('item', e => {
	...
	e.removeAllTagsFrom("blocksyouneed_luna:brass_ingot")
	e.removeAllTagsFrom("blocksyouneed_luna:brass_block")
	e.removeAllTagsFrom("blocksyouneed_luna:aluminum_ingot")
	e.removeAllTagsFrom("blocksyouneed_luna:aluminum_block")
	e.removeAllTagsFrom("blocksyouneed_luna:steel_ingot")
